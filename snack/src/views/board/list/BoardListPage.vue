...
useHead({
  title: '밥친구 모집 게시판 - HUNGLL',
  meta: [
    {
      name: 'description',
      content: '혼밥은 이제 그만! HUNGLL의 밥친구 게시판에서 함께 식사할 친구를 찾아보세요. 지역, 시간대, 식사 스타일별로 다양한 모임이 등록되어 있습니다.',
    },
    {
      name: 'keywords',
      content: '헝글, 밥친구, 밥약, 식사메이트, 밥약, 혼밥탈출, 식사모임, 맛집모임',
    },
    { property: 'og:title', content: '밥친구 모집 게시판 - HUNGLL' },
